...
const resend = new Resend(ENV.SMTP_PASS); // Use Resend API key directly

export class EmailService {
  /**
   * Send a 6-digit OTP to the user's email via Resend API.
   */
  ...
  /**
   * Send a welcome email after account creation via Resend API.
   */
