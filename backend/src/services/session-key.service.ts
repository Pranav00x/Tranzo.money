...
export class SessionKeyService {
  private static ENTRY_POINT = getEntryPoint("0.7");
  private static KERNEL_VERSION = KERNEL_V3_1;
   ...
   */
  static async createAndInstallSessionKey(
    masterSignerPrivateKey: `0x${string}`,
    spendLimitEth: string = "0.1"
   ...
   */
  static async executeWithSessionKey(
    smartAccountAddress: `0x${string}`,
    sessionKeyPK: `0x${string}`,
    to: `0x${string}`,
    value: bigint,
