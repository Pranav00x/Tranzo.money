...
export class PasskeyService {
    static RP_NAME = "Tranzo";
    static RP_ID = process.env.RP_ID || "tranzo.app";
    static ORIGIN = process.env.ORIGIN || "https://tranzo.app";
    /**
     * Step 1: Generate registration options for the client
     */
    static async getRegistrationOptions(userId, email) {
     ...
     */
    static async verifyRegistration(userId, body, expectedChallenge) {
     ...
     */
    static async getAuthenticationOptions(userId) {
        const userPasskeys = await prisma.passkey.findMany({
            where: { userId }
        });
     ...
     */
    static async verifyAuthentication(userId, body, expectedChallenge) {
